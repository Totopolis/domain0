...
namespace Domain0.Api.Client
{
    ...
    public partial interface IDomain0Client
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="Domain0ClientException">A server side error occurred.</exception>
        System.Threading.Tasks.Task<System.Collections.Generic.List<Environment>> GetEnvironmentsAvalibleForCreateUsersAsync();
    
        /// <summary>Method for receive environments</summary>
        /// <returns>Success</returns>
        /// <exception cref="Domain0ClientException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        System.Threading.Tasks.Task<System.Collections.Generic.List<Environment>> GetEnvironmentsAvalibleForCreateUsersAsync(System.Threading.CancellationToken cancellationToken);
    ...
    public partial class Domain0Client : IDomain0Client
    {
        ...
        /// <returns>Success</returns>
        /// <exception cref="Domain0ClientException">A server side error occurred.</exception>
        public System.Threading.Tasks.Task<System.Collections.Generic.List<Environment>> GetEnvironmentsAvalibleForCreateUsersAsync()
        {
            return GetEnvironmentsAvalibleForCreateUsersAsync(System.Threading.CancellationToken.None);
        }
        ...
        /// <exception cref="Domain0ClientException">A server side error occurred.</exception>
        /// <param name="cancellationToken">A cancellation token that can be used by other objects or threads to receive notice of cancellation.</param>
        public async System.Threading.Tasks.Task<System.Collections.Generic.List<Environment>> GetEnvironmentsAvalibleForCreateUsersAsync(System.Threading.CancellationToken cancellationToken)
        {
            var urlBuilder_ = new System.Text.StringBuilder();
            urlBuilder_.Append(BaseUrl != null ? BaseUrl.TrimEnd('/') : "").Append("/api/environments/AvalibleForCreateUsers");
